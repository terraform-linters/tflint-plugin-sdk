...
var file_tflint_proto_rawDesc = []byte{
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xf9, 0x01, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x4d, 0x6f,
	0x64, 0x75, 0x6c, 0x65, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x1a, 0x3d, 0x0a, 0x06, 0x4f,
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x33, 0x0a, 0x0a, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x5f,
	0x63, 0x74, 0x78, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x2e, 0x4d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x43, 0x74, 0x78, 0x54, 0x79, 0x70, 0x65, 0x52,
	0x09, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x43, 0x74, 0x78, 0x1a, 0x6c, 0x0a, 0x07, 0x52, 0x65,
...
var file_tflint_proto_msgTypes = make([]protoimpl.MessageInfo, 56)
var file_tflint_proto_goTypes = []interface{}{
	...
	(*GetModuleContent_Option)(nil),       // 37: proto.GetModuleContent.Option
	(*GetModuleContent_Request)(nil),      // 38: proto.GetModuleContent.Request
	(*GetModuleContent_Response)(nil),     // 39: proto.GetModuleContent.Response
	(*GetFile_Request)(nil),               // 40: proto.GetFile.Request
	(*GetFile_Response)(nil),              // 41: proto.GetFile.Response
	(*GetFiles_Request)(nil),              // 42: proto.GetFiles.Request
	(*GetFiles_Response)(nil),             // 43: proto.GetFiles.Response
	nil,                                   // 44: proto.GetFiles.Response.FilesEntry
	(*GetRuleConfigContent_Request)(nil),  // 45: proto.GetRuleConfigContent.Request
	(*GetRuleConfigContent_Response)(nil), // 46: proto.GetRuleConfigContent.Response
	(*EvaluateExpr_Option)(nil),           // 47: proto.EvaluateExpr.Option
	(*EvaluateExpr_Request)(nil),          // 48: proto.EvaluateExpr.Request
	(*EvaluateExpr_Response)(nil),         // 49: proto.EvaluateExpr.Response
	(*EmitIssue_Rule)(nil),                // 50: proto.EmitIssue.Rule
	(*EmitIssue_Request)(nil),             // 51: proto.EmitIssue.Request
	(*EmitIssue_Response)(nil),            // 52: proto.EmitIssue.Response
	(*BodySchema_Attribute)(nil),          // 53: proto.BodySchema.Attribute
	(*BodySchema_Block)(nil),              // 54: proto.BodySchema.Block
	(*BodyContent_Attribute)(nil),         // 55: proto.BodyContent.Attribute
	(*BodyContent_Block)(nil),             // 56: proto.BodyContent.Block
	nil,                                   // 57: proto.BodyContent.AttributesEntry
	(*Range_Pos)(nil),                     // 58: proto.Range.Pos
}
var file_tflint_proto_depIdxs = []int32{
	53, // 0: proto.BodySchema.attributes:type_name -> proto.BodySchema.Attribute
	54, // 1: proto.BodySchema.blocks:type_name -> proto.BodySchema.Block
	57, // 2: proto.BodyContent.attributes:type_name -> proto.BodyContent.AttributesEntry
	56, // 3: proto.BodyContent.blocks:type_name -> proto.BodyContent.Block
	58, // 4: proto.Range.start:type_name -> proto.Range.Pos
	58, // 5: proto.Range.end:type_name -> proto.Range.Pos
	...
	16, // 13: proto.GetModuleContent.Request.schema:type_name -> proto.BodySchema
	37, // 14: proto.GetModuleContent.Request.option:type_name -> proto.GetModuleContent.Option
	17, // 15: proto.GetModuleContent.Response.content:type_name -> proto.BodyContent
	44, // 16: proto.GetFiles.Response.files:type_name -> proto.GetFiles.Response.FilesEntry
	16, // 17: proto.GetRuleConfigContent.Request.schema:type_name -> proto.BodySchema
	17, // 18: proto.GetRuleConfigContent.Response.content:type_name -> proto.BodyContent
	0,  // 19: proto.EvaluateExpr.Option.module_ctx:type_name -> proto.ModuleCtxType
	18, // 20: proto.EvaluateExpr.Request.expr_range:type_name -> proto.Range
	47, // 21: proto.EvaluateExpr.Request.option:type_name -> proto.EvaluateExpr.Option
	2,  // 22: proto.EmitIssue.Rule.severity:type_name -> proto.EmitIssue.Severity
	50, // 23: proto.EmitIssue.Request.rule:type_name -> proto.EmitIssue.Rule
	18, // 24: proto.EmitIssue.Request.range:type_name -> proto.Range
	16, // 25: proto.BodySchema.Block.body:type_name -> proto.BodySchema
	18, // 26: proto.BodyContent.Attribute.expr_range:type_name -> proto.Range
	18, // 27: proto.BodyContent.Attribute.range:type_name -> proto.Range
	18, // 28: proto.BodyContent.Attribute.name_range:type_name -> proto.Range
	17, // 29: proto.BodyContent.Block.body:type_name -> proto.BodyContent
	18, // 30: proto.BodyContent.Block.def_range:type_name -> proto.Range
	18, // 31: proto.BodyContent.Block.type_range:type_name -> proto.Range
	18, // 32: proto.BodyContent.Block.label_ranges:type_name -> proto.Range
	55, // 33: proto.BodyContent.AttributesEntry.value:type_name -> proto.BodyContent.Attribute
	20, // 34: proto.RuleSet.GetName:input_type -> proto.GetName.Request
	22, // 35: proto.RuleSet.GetVersion:input_type -> proto.GetVersion.Request
	24, // 36: proto.RuleSet.GetRuleNames:input_type -> proto.GetRuleNames.Request
	26, // 37: proto.RuleSet.GetConfigSchema:input_type -> proto.GetConfigSchema.Request
	30, // 38: proto.RuleSet.ApplyGlobalConfig:input_type -> proto.ApplyGlobalConfig.Request
	33, // 39: proto.RuleSet.ApplyConfig:input_type -> proto.ApplyConfig.Request
	35, // 40: proto.RuleSet.Check:input_type -> proto.Check.Request
	38, // 41: proto.Runner.GetModuleContent:input_type -> proto.GetModuleContent.Request
	40, // 42: proto.Runner.GetFile:input_type -> proto.GetFile.Request
	42, // 43: proto.Runner.GetFiles:input_type -> proto.GetFiles.Request
	45, // 44: proto.Runner.GetRuleConfigContent:input_type -> proto.GetRuleConfigContent.Request
	48, // 45: proto.Runner.EvaluateExpr:input_type -> proto.EvaluateExpr.Request
	51, // 46: proto.Runner.EmitIssue:input_type -> proto.EmitIssue.Request
	21, // 47: proto.RuleSet.GetName:output_type -> proto.GetName.Response
	23, // 48: proto.RuleSet.GetVersion:output_type -> proto.GetVersion.Response
	25, // 49: proto.RuleSet.GetRuleNames:output_type -> proto.GetRuleNames.Response
	27, // 50: proto.RuleSet.GetConfigSchema:output_type -> proto.GetConfigSchema.Response
	31, // 51: proto.RuleSet.ApplyGlobalConfig:output_type -> proto.ApplyGlobalConfig.Response
	34, // 52: proto.RuleSet.ApplyConfig:output_type -> proto.ApplyConfig.Response
	36, // 53: proto.RuleSet.Check:output_type -> proto.Check.Response
	39, // 54: proto.Runner.GetModuleContent:output_type -> proto.GetModuleContent.Response
	41, // 55: proto.Runner.GetFile:output_type -> proto.GetFile.Response
	43, // 56: proto.Runner.GetFiles:output_type -> proto.GetFiles.Response
	46, // 57: proto.Runner.GetRuleConfigContent:output_type -> proto.GetRuleConfigContent.Response
	49, // 58: proto.Runner.EvaluateExpr:output_type -> proto.EvaluateExpr.Response
	52, // 59: proto.Runner.EmitIssue:output_type -> proto.EmitIssue.Response
